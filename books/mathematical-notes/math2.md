...
$\bigcup_{\sigma \in \mathfrak{S}_n} \sigma(\tilde{\mathcal{T}}_{n - 1}) \supset E_n^0 / \Delta$

$\mathcal{S}_n \coloneqq \mathrm{pr}^*(\tilde{W}_n|_{E_n^0 / \Delta}) \in \Gamma^\omega(E_n^0, ((SO(E) \ltimes E) \times_{SO(E)} (R^* \otimes \mathbb{C}))^{\boxtimes n})$
